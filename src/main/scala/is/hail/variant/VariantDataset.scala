...
class VariantDatasetFunctions(private val vds: VariantSampleMatrix[Genotype]) extends AnyVal {
  ...
  def linreg(y: String, covariates: Array[String] = Array.empty[String], root: String = "va.linreg", useDosages: Boolean = false, minAC: Int = 0, minAF: Double = 0d): VariantDataset = {
